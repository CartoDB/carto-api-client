...
describe('layer-map', () => {
  ...
  describe('color accessors', () => {
    ...
    test.each(COLOR_TESTS)('getColorAccessor $colorScale', (testCase) => {
      const accessor = getColorAccessor(testCase.colorField, testCase.colorScale, {range: testCase.colorRange}, testCase.opacity, testCase.data);
  ...
  describe('size accessors', () => {
    ...
    test.each(SIZE_TESTS)('getSizeAccessor $sizeScale', (testCase) => {
      const accessor = getSizeAccessor(testCase.sizeField, testCase.sizeScale, undefined, testCase.sizeRange, testCase.data);
  ...
  describe('text accessors', () => {
    ...
    test.each(TEXT_TESTS)('getTextAccessor $textLabelField.type', (testCase) => {
      const accessor = getTextAccessor(testCase.textLabelField, [testCase.data]);
